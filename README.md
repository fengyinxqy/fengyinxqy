...
前端开发 3 年经验，熟悉 Vue/React 生态，擅长构建流畅的用户体验。

目前正在突破后端边界，系统学习 **MySQL 数据库** 从基础查询到索引优化、事务处理。

相信 **「理解全栈才能做好前端」**，正在一步步补齐后端知识体系，目标是成为能够独立设计并实现完整产品的全栈开发者。
